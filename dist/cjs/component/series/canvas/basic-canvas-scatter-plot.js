...
exports.BasicCanvasScatterPlot = exports.BasicCanvasScatterPlotModel = void 0;
...
exports.BasicCanvasScatterPlotModel = BasicCanvasScatterPlotModel;
var BasicCanvasScatterPlot = /** @class */ (function (_super) {
    tslib_1.__extends(BasicCanvasScatterPlot, _super);
    ...
    BasicCanvasScatterPlot.prototype.drawSeries = function (chartData, scales, geometry, option) {
        ...
        if (this.isRestore && this.bufferCanvas) {
            ...
            if (!this.isZoom && totalCount_1 >= 100000) {
                ...
                var arrayAsObservable = (0, rxjs_1.of)(null).pipe((0, operators_1.switchMap)(function () { return _this.getObjectWithArrayInPromise((0, d3_array_1.range)(shareCount_1)); }), (0, operators_1.map)(function (val) {
                    return val.data;
                }), (0, operators_1.switchMap)(function (val) { return (0, rxjs_1.from)(val); }));
                var eachElementAsObservable = arrayAsObservable.pipe((0, operators_1.concatMap)(function (value) { return (0, rxjs_1.timer)(400).pipe((0, operators_1.mapTo)(value)); }), // Not working : we want to wait 500ms for each value
        ...
        (0, d3_svg_util_1.delayExcute)(100, function () {
...
exports.BasicCanvasScatterPlot = BasicCanvasScatterPlot;
