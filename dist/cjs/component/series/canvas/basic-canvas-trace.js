...
exports.BasicCanvasTrace = exports.BasicCanvasTraceModel = void 0;
...
exports.BasicCanvasTraceModel = BasicCanvasTraceModel;
var BasicCanvasTrace = /** @class */ (function (_super) {
    tslib_1.__extends(BasicCanvasTrace, _super);
    ...
    BasicCanvasTrace.prototype.setSvgElement = function (svg, mainGroup, index) {
        ...
        if (!this.chartBase.chartContainer.select('.' + chart_1.ChartSelector.SELECTION_CANVAS).node()) {
            ...
            this.chartBase.chartContainer.select('.' + chart_1.ChartSelector.SELECTION_CANVAS).style('z-index', index + 3);
        }
    };
    BasicCanvasTrace.prototype.drawSeries = function (chartBaseData, scales, geometry, option) {
        ...
        var rgbColor = (0, d3_color_1.rgb)(this.strokeColor);
        ...
        if (option.displayType === chart_interface_1.DisplayType.ZOOMOUT && this.restoreCanvas) {
        ...
        if (option.displayType === chart_interface_1.DisplayType.NORMAL || (option.displayType === chart_interface_1.DisplayType.ZOOMOUT && !this.restoreCanvas)) {
            this.restoreCanvas = (0, d3_selection_1.select)(document.createElement('CANVAS'));
        ...
        if (generateData.length >= 500000) {
            (0, d3_svg_util_1.delayExcute)(200, makeQuadtree);
        }
        else {
            makeQuadtree();
        }
    ...
    BasicCanvasTrace.prototype.showPointAndTooltip = function (value, selected) {
        ...
        if (!this.chartBase.isTooltipDisplay) {
            ...
            (0, tooltip_util_1.setChartTooltipByPosition)(this.tooltipGroup, this.chartBase.tooltip && this.chartBase.tooltip.tooltipTextParser
...
exports.BasicCanvasTrace = BasicCanvasTrace;
