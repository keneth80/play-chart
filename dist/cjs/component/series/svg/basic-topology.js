...
exports.BasicTopology = exports.TopologyData = exports.GeometryLink = exports.TopologyGroupElement = exports.Geometry = void 0;
...
var TopologyGroupElement = /** @class */ (function (_super) {
    tslib_1.__extends(TopologyGroupElement, _super);
    function TopologyGroupElement(id, x, y, width, height, rx, ry, data, members) {
        ...
        Object.assign(_this, {
            ...
            members: tslib_1.__spreadArray([], members, true)
        });
        return _this;
    }
    return TopologyGroupElement;
}(Geometry));
exports.TopologyGroupElement = TopologyGroupElement;
...
exports.GeometryLink = GeometryLink;
...
var BasicTopology = /** @class */ (function (_super) {
    tslib_1.__extends(BasicTopology, _super);
    function BasicTopology(configuration) {
        var _this = _super.call(this, configuration) || this;
        _this.boldColor = '#0384fc';
        _this.onMachineOver = function (event, data) {
            _this.currentSector = (0, d3_selection_1.select)(event.target).style('stroke', _this.boldColor);
            ...
            _this.mainGroup
                ...
                var memeberId = (0, d3_selection_1.select)(node[i]).attr('id');
        ...
        _this.onMachineOut = function (event, data) {
            _this.currentSector = (0, d3_selection_1.select)(event.target).style('stroke', '');
        ...
        _this.onMemberMouseOver = function (event, data) {
            var index = (0, d3_svg_util_1.getElementInfoByEvent)(event).index;
    ...
    BasicTopology.prototype.drawSeries = function (chartData, scales, geometry) {
        ...
        // link draw
        var vlink = (0, d3_shape_1.linkVertical)()
    ...
    BasicTopology.prototype.getPositionFromTarget = function (targetGroup, sectors, machines, memberSize, machineSize, placement) {
        ...
        sectors.forEach(function (item) {
            ...
            var parentPosition = (0, d3_svg_util_1.getTransformByArray)(currentSector.attr('transform'));
            for (var i = 0; i < item.members.length; i++) {
                var currentMember = currentSector.select("#".concat(item.members[i].memberID.toLowerCase()));
                var memberPosition = (0, d3_svg_util_1.getTransformByArray)(currentMember.attr('transform'));
                var position = [];
                position.push({
                ...
                for (var j = 0; j < machines.length; j++) {
                    if (item.members[i].machineIP === machines[j].data.machineID) {
                        ...
                        var machinePosition = (0, d3_svg_util_1.getTransformByArray)(currentMachine.attr('transform'));
                        position.push({
    ...
    BasicTopology.prototype.drawMember = function (targetGroup, selector, memberGeometry, memberPadding, placement) {
        ...
        texts.each(function (d, index, nodeList) {
            (0, d3_svg_util_1.wrapTextByRowLimit)((0, d3_selection_1.select)(nodeList[index]), memberGeometry.width, 1);
        });
        return memberGroup;
    };
    BasicTopology.prototype.drawMachine = function (targetGroup, selector, machineGeometry) {
        ...
        // text 자르기
        texts.each(function (d, index, nodeList) {
            (0, d3_svg_util_1.wrapTextByRowLimit)((0, d3_selection_1.select)(nodeList[index]), machineGeometry.width, 1);
        });
        // y position 센터로 정렬
...
exports.BasicTopology = BasicTopology;
