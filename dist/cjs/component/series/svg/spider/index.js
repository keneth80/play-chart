...
var chart_interface_1 = require("../../../../component/chart/chart.interface");
...
var SpiderSeries = /** @class */ (function (_super) {
    ...
    SpiderSeries.prototype.drawSeries = function (chartData, scales, geometry, displayOption) {
        var _this = this;
        if (displayOption.displayType === chart_interface_1.DisplayType.ZOOMIN) {
            return;
        }
        ...
        var axisLabel = this.mainGroup
            ...
            if (_this.labelWidth) {
                (0, util_1.textWrapping)((0, d3_selection_1.select)(node[i]), _this.labelWidth);
            }
        });
