...
var BasicStepArea = /** @class */ (function (_super) {
    ...
    BasicStepArea.prototype.drawOptions = function (chartData, scales, geometry) {
        ...
        var x = xScale.scale;
        var textHeight = (0, util_1.getTextHeight)(12, 'Arial, Helvetica, sans-serif');
        ...
        this.mainGroup
            ...
            .attr('clip-path', this.svg.select(".".concat(chart_1.ChartSelector.SERIES_SVG)).attr('clip-path'));
...
exports.BasicStepArea = BasicStepArea;
