...
exports.setupWebglContext = exports.createProgramFromSources = exports.createProgramFromScripts = exports.rgbToHex = exports.hexToRgb = void 0;
...
var rgbToHex = function (r, g, b) { return '#' + [r, g, b].map(function (x) { return x.toString(16).padStart(2, '0'); }).join(''); };
exports.rgbToHex = rgbToHex;
var createProgramFromScripts = function (gl, shaderScriptIds, optAttribs, optLocations, optErrorCallback) {
    var shaders = [];
...
var createProgramFromSources = function (gl, shaderSources, optAttribs, optLocations, optErrorCallback) {
    var shaders = [];
...
var setupWebglContext = function (canvas) {
    var _a;
    var webglOption = {
        alpha: true,
        antialias: true,
...
exports.setupWebglContext = setupWebglContext;
