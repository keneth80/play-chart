...
exports.centerPositionForTooltipElement = exports.setChartTooltipByPosition = exports.setIndexChartTooltipByPosition = exports.setMultiChartTooltipByPosition = void 0;
var d3_selection_1 = require("d3-selection");
var _1 = require(".");
var setMultiChartTooltipByPosition = function (tooltipTarget, tooltipText, chartGeometry, position, prevGroup, index) {
    ...
    if (prevGroup) {
        ...
        transform = (0, _1.getTransformByArray)(prevGroup.attr('transform'));
    }
...
exports.setMultiChartTooltipByPosition = setMultiChartTooltipByPosition;
var setIndexChartTooltipByPosition = function (tooltipTarget, tooltipText, chartGeometry, position, tooltipPointerSize, margin, prevGroup, index) {
...
exports.setIndexChartTooltipByPosition = setIndexChartTooltipByPosition;
var setChartTooltipByPosition = function (tooltipTarget, tooltipText, chartGeometry, position, tooltipPointerSize, margin) {
    var textElement = tooltipTarget
        .select('text')
        .attr('dy', '.1em')
        .text(tooltipText);
...
exports.setChartTooltipByPosition = setChartTooltipByPosition;
var centerPositionForTooltipElement = function (chart, tooltipElement, position, padding) {
    ...
    (0, d3_selection_1.select)(tooltipElement)
...
exports.centerPositionForTooltipElement = centerPositionForTooltipElement;
