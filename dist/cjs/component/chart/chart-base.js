...
var chart_interface_1 = require("./chart.interface");
var grid_line_1 = require("./grid-line");
var legend_1 = require("./legend");
var scale_1 = require("./scale");
var tooltip_template_1 = require("./tooltip/tooltip-template");
var canvas_util_1 = require("./util/canvas-util");
var chart_util_1 = require("./util/chart-util");
var d3_svg_util_1 = require("./util/d3-svg-util");
var tooltip_util_1 = require("./util/tooltip-util");
var webgl_util_1 = require("./util/webgl-util");
// TODO: 모든 참조되는 함수들은 subject로 바꾼다.
var ChartBase = /** @class */ (function () {
    function ChartBase(configuration) {
        var _this = this;
        this.isResize = false;
        this.mouseEventSubject = new rxjs_1.Subject();
        this.zoomEventSubject = new rxjs_1.Subject();
        this.chartItemEventSubject = new rxjs_1.Subject();
        ...
        this.functionList = [];
        this.optionList = [];
        this.chartClickSubject = new rxjs_1.Subject();
        this.tooltipTemplete = tooltip_template_1.baseTooltipTemplate;
        this.margin = {
            top: 25,
            left: 20,
            bottom: 30,
        ...
        this.tooltipEventSubject = new rxjs_1.Subject();
        // series delay display observable
        this.eachElementAsObservableSubscription = new rxjs_1.Subscription();
        this.prevCurrentItemHash = '';
        this.crossFilterObject = null;
        this.chartLifecycleSubject = new rxjs_1.Subject();
        ...
        this.resizeEventHandler = function () {
            ...
            _this.updateDisplay(chart_interface_1.DisplayType.RESIZE);
        ...
        this.onLegendLabelItemClick = function (event, d) {
            ...
            var _a = (0, d3_svg_util_1.getElementInfoByEvent)(event), index = _a.index, nodeList = _a.nodeList;
            if (d.label === 'All') {
        ...
        this.onLegendAllLabelItemSelect = function (d, index, nodeList) {
            ...
            (0, d3_selection_1.select)(nodeList[index]).style('opacity', d.selected === false ? 0.5 : null);
            _this.legendGroup
    ...
    Object.defineProperty(ChartBase.prototype, "webglElementContext", {
        ...
        get: function () {
            if (!this.webglCanvas) {
                this.webglCanvas = (0, d3_selection_1.select)(document.createElement('CANVAS'));
                this.webglCanvas.attr('width', this.width).attr('height', this.height);
                if (!this.webglContext) {
                    this.webglContext = (0, webgl_util_1.setupWebglContext)(this.webglCanvas);
                }
            }
    ...
    Object.defineProperty(ChartBase.prototype, "chartMargin", {
        get: function () {
            var transform = (0, d3_svg_util_1.getTransformByArray)(this.mainGroup.attr('transform'));
    ...
    ChartBase.prototype.initialize = function (configuration) {
        ...
        if (configuration.margin) {
            ...
            this.config.axes.forEach(function (axis) {
                ...
                if (axis.placement === chart_configuration_1.Placement.TOP || axis.placement === chart_configuration_1.Placement.BOTTOM) {
                    _this.margin[axis.placement] = 30;
                }
            });
        }
        this.selector = (0, d3_selection_1.select)(configuration.selector);
        ...
        this.crossFilterObject = (0, crossfilter2_1.default)(this.originalData);
        ...
        if (configuration.colors && configuration.colors.length) {
            ...
            this.colors = d3_scale_chromatic_1.schemeCategory10.map(function (color) { return color; });
        }
    ...
    ChartBase.prototype.realTime = function (isRealTime, duration, term) {
        ...
        if (isRealTime) {
            this.realTimeSubscription = (0, rxjs_1.interval)(duration)
                .pipe((0, operators_1.delay)(500))
                .subscribe(function (value) {
                // x axis의 domain을 현 시간으로 계속 업데이트 해줘야함.
                var newTime = new Date().getTime();
                var axesItem = _this.config.axes.find(function (item) { return item.placement === chart_configuration_1.Placement.BOTTOM || item.placement === chart_configuration_1.Placement.TOP; });
    ...
    ChartBase.prototype.series = function (seriesConfigurations) {
        var _this = this;
        new rxjs_1.Observable(function (observ) {
            observ.next(true);
            observ.complete();
        })
        ...
        }), (0, operators_1.delay)(50), (0, operators_1.tap)(function () {
            _this.seriesList.length = 0;
            for (var i = 0; i < seriesConfigurations.length; i++) {
                _this.seriesList.push((0, chart_util_1.makeSeriesByConfigurationType)(seriesConfigurations[i]));
            }
        }))
            .subscribe(function () {
            _this.updateLegend();
    ...
    ChartBase.prototype.showTooltipBySeriesSelector = function (selector) {
        ...
        if (series) {
            ...
            series.unSelectItem();
            (0, d3_svg_util_1.delayExcute)(50, function () {
    ...
    ChartBase.prototype.targetSeriesUpdate = function (series, index) {
        ...
        return new Promise(function (resolve) {
            ...
            series.drawSeries(_this.originalData, _this.scales, {
                ...
                displayType: chart_interface_1.DisplayType.NORMAL
            });
            resolve();
        });
    };
    ...
    ChartBase.prototype.updateSeries = function (displayType) {
        var _this = this;
        if (displayType === void 0) { displayType = chart_interface_1.DisplayType.NORMAL; }
        try {
            if (this.seriesList && this.seriesList.length) {
                if (!this.config.displayDelay) {
                    var xScale_1 = this.scales.find(function (scale) { return scale.orient === chart_configuration_1.Placement.BOTTOM || scale.orient === chart_configuration_1.Placement.TOP; });
                    var yScale_1 = this.scales.find(function (scale) { return scale.orient === chart_configuration_1.Placement.LEFT || scale.orient === chart_configuration_1.Placement.RIGHT; });
                    this.seriesList.map(function (series, index) {
                        ...
                        series.drawSeries(
                        // this.originalData
                        displayType === chart_interface_1.DisplayType.ZOOMIN
                ...
                // 시간차로 그리기.
                var arrayAsObservable = (0, rxjs_1.of)(null).pipe(
                // delay(this.config.displayDelay.delayTime),
                (0, operators_1.switchMap)(function () { return _this.getObjectWithArrayInPromise(_this.seriesList); }), (0, operators_1.map)(function (val) {
                    return val.data;
                }), (0, operators_1.switchMap)(function (val) { return (0, rxjs_1.from)(val); }));
                var eachElementAsObservable = arrayAsObservable.pipe((0, operators_1.concatMap)(function (value) { return (0, rxjs_1.timer)(_this.config.displayDelay.delayTime).pipe((0, operators_1.mapTo)(value)); }), // Not working : we want to wait 500ms for each value
                (0, operators_1.map)(function (val) {
                    return val;
                }));
    ...
    ChartBase.prototype.getObjectWithArrayInPromise = function (list) {
        ...
        return new Promise(function (resolve) {
            (0, d3_svg_util_1.delayExcute)(20, function () {
                return resolve({
                    data: data
                });
            });
    ...
    ChartBase.prototype.pointerClear = function () {
        var selectionCanvas = this.selector.select('.' + chart_selector_variable_1.ChartSelector.POINTER_CANVAS);
        if (selectionCanvas && selectionCanvas.node()) {
            var context = selectionCanvas.node().getContext('2d');
            (0, canvas_util_1.clearCanvas)(context, this.width, this.height);
        }
    ...
    ChartBase.prototype.selectionClear = function () {
        ...
        var selectionCanvas = this.selector.select('.' + chart_selector_variable_1.ChartSelector.SELECTION_CANVAS);
        if (selectionCanvas && selectionCanvas.node()) {
            var context = selectionCanvas.node().getContext('2d');
            (0, canvas_util_1.clearCanvas)(context, this.width, this.height);
        }
    ...
    ChartBase.prototype.setRootSize = function () {
        ...
        if (this.isTitle) {
            this.titleContainerSize.width =
                this.titlePlacement === chart_configuration_1.Placement.TOP || this.titlePlacement === chart_configuration_1.Placement.BOTTOM ? this.width : 20;
            this.titleContainerSize.height =
                this.titlePlacement === chart_configuration_1.Placement.TOP || this.titlePlacement === chart_configuration_1.Placement.BOTTOM ? 20 : this.height;
            this.width = this.width - (this.titlePlacement === chart_configuration_1.Placement.LEFT || this.titlePlacement === chart_configuration_1.Placement.RIGHT ? 20 : 0);
            this.height = this.height - (this.titlePlacement === chart_configuration_1.Placement.LEFT || this.titlePlacement === chart_configuration_1.Placement.RIGHT ? 0 : 20);
        }
        // 범례 적용 시 사이즈 계산.
        if (this.isLegend) {
            this.initLegend();
    ...
    ChartBase.prototype.initLegend = function () {
        this.chartLegend = new legend_1.ChartLegend({
            isCheckBox: this.isLegendCheckBox,
            isAll: this.isLegendAll,
            addTitleWidth: this.isTitle && this.titlePlacement === chart_configuration_1.Placement.LEFT ? this.titleContainerSize.width : 0,
        ...
        this.width =
            this.width -
                (this.legendPlacement === chart_configuration_1.Placement.LEFT || this.legendPlacement === chart_configuration_1.Placement.RIGHT ? this.legendContainerSize.width : 0);
        this.height =
            this.height -
                (this.legendPlacement === chart_configuration_1.Placement.TOP || this.legendPlacement === chart_configuration_1.Placement.BOTTOM
    ...
    ChartBase.prototype.initContainer = function () {
        ...
        var x = this.margin.left +
            ...
            (this.isTitle && this.titlePlacement === chart_configuration_1.Placement.LEFT ? this.titleContainerSize.width : 0) +
            (this.isLegend && this.legendPlacement === chart_configuration_1.Placement.LEFT ? this.legendContainerSize.width : 0);
        var y = this.margin.top +
            this.axisTitleMargin.top +
            (this.isTitle && this.titlePlacement === chart_configuration_1.Placement.TOP ? this.titleContainerSize.height : 0) +
            (this.isLegend && this.legendPlacement === chart_configuration_1.Placement.TOP ? this.legendContainerSize.height : 0);
        ...
        if (this.isLegend) {
            ...
            this.legendGroup.attr('transform', function () {
                ...
                if (_this.legendPlacement === chart_configuration_1.Placement.RIGHT) {
                ...
                else if (_this.legendPlacement === chart_configuration_1.Placement.LEFT) {
                    legendX_1 = _this.isTitle && _this.titlePlacement === chart_configuration_1.Placement.LEFT ? _this.titleContainerSize.width : 0;
                    translate = "translate(".concat(legendX_1, ", ").concat(legendY_1, ")");
                }
                else if (_this.legendPlacement === chart_configuration_1.Placement.TOP) {
                    legendX_1 = _this.legendPadding;
                    legendY_1 =
                        (_this.isTitle && _this.titlePlacement === chart_configuration_1.Placement.TOP ? _this.titleContainerSize.height : 0) +
                            _this.legendPadding;
                    translate = "translate(".concat(legendX_1, ", ").concat(legendY_1, ")");
                }
                else if (_this.legendPlacement === chart_configuration_1.Placement.BOTTOM) {
                    legendX_1 = _this.legendPadding;
                    legendY_1 = _this.margin.top + _this.margin.bottom + (_this.axisTitleMargin.top + _this.axisTitleMargin.bottom) + height;
                    if (_this.isTitle && _this.titlePlacement === chart_configuration_1.Placement.TOP) {
        ...
        if (!this.seriesGroup) {
            this.seriesGroup = this.svg.append('g').attr('class', chart_selector_variable_1.ChartSelector.SERIES_SVG);
        }
        this.seriesGroup.attr('transform', "translate(".concat(x, ", ").concat(y, ")")).attr('clip-path', "url(#".concat(this.maskId, ")"));
        if (!this.selectionGroup) {
            this.selectionGroup = this.svg.append('g').attr('class', chart_selector_variable_1.ChartSelector.SELECTION_SVG);
        }
        ...
        if (!this.zoomGroup) {
            this.zoomGroup = this.svg.append('g').attr('class', chart_selector_variable_1.ChartSelector.ZOOM_SVG);
            this.zoomGroup
                .append('rect')
                .attr('class', chart_selector_variable_1.ChartSelector.ZOOM_SVG + '-background')
                .style('fill', 'none')
                .style('pointer-events', 'all');
        }
        this.zoomGroup.attr('transform', "translate(".concat(x, ", ").concat(y, ")"));
        this.zoomGroup
            .select('.' + chart_selector_variable_1.ChartSelector.ZOOM_SVG + '-background')
    ...
    ChartBase.prototype.addEventListner = function () {
        ...
        if (this.config.isResize && this.config.isResize === true) {
            var resizeEvent = (0, rxjs_1.fromEvent)(window, 'resize').pipe((0, operators_1.debounceTime)(500));
            ...
            switch (chartEvent.type) {
                case 'mousemove':
                    ...
                    if (_this.config.tooltip && !isDragStart && !isMouseLeave) {
                        ...
                        while (maxLength--) {
                            ...
                            if (positionData.length) {
                                ...
                                if (currentChartItemIndex > -1) {
                                    ...
                                    var currentTooltipData = tslib_1.__spreadArray([], positionData[currentChartItemIndex], true);
                                    if (tooltipTargetDataList.length < 4) {
                                        ...
                                        tooltipPointerDataList.push({
                                            seriesIndex: maxLength,
                                            position: tslib_1.__spreadArray([], chartEvent.position, true),
                                            positionData: tslib_1.__spreadArray([], positionData, true)
                                        });
                                    }
                        ...
                        var newHash = (0, object_hash_1.sha1)(tooltipTargetDataList);
    ...
    ChartBase.prototype.drawTooltipContents = function (seriesList, tooltipTargetList, tooltipTextParser) {
        ...
        var itemGroup = this.tooltipGroup
            ...
            var group = (0, d3_selection_1.select)(nodeList[index]);
            var prevGroup = index > 0 ? (0, d3_selection_1.select)(nodeList[index - 1]) : undefined;
            ...
            _this.isTooltipMultiple
                ? (0, tooltip_util_1.setMultiChartTooltipByPosition)(group, tooltipTextParser ? tooltipTextParser(d.tooltipData) : d.tooltipText(d.tooltipData), {
                    width: _this.width,
                    height: _this.height
                }, [positionx, positiony], prevGroup, index)
                : (0, tooltip_util_1.setChartTooltipByPosition)(group, tooltipTextParser ? tooltipTextParser(d.tooltipData) : d.tooltipText(d.tooltipData), {
                    width: _this.width,
                    height: _this.height
                }, [positionx, positiony], {
    ...
    ChartBase.prototype.drawTooltip = function (currentSeries, currentTooltipData, tooltipTextParser) {
        ...
        (0, tooltip_util_1.setChartTooltipByPosition)(tooltipGroup, tooltipTextParser ? tooltipTextParser(currentTooltipData) : currentSeries.tooltipText(currentTooltipData), {
            width: this.width,
            height: this.height
    ...
    ChartBase.prototype.zoominEventHandler = function (chartEvent) {
        ...
        this.updateSeries(chart_interface_1.DisplayType.ZOOMIN);
        this.updateOptions();
    };
    ChartBase.prototype.zoomoutEventHandler = function () {
        ...
        this.updateRescaleAxis(false);
        this.updateFunctions();
        this.updateSeries(chart_interface_1.DisplayType.ZOOMOUT);
        this.updateOptions();
    };
    ...
    ChartBase.prototype.updateTitle = function () {
        ...
        if (this.titleGroup) {
            this.titleGroup.attr('transform', function (d) {
                ...
                var titleY = 0;
                var padding = 5;
                if (d.placement === chart_configuration_1.Placement.RIGHT) {
                    titleX =
                        _this.width +
                            _this.margin.left +
                            _this.margin.right +
                            _this.titleContainerSize.width +
                            (_this.isLegend && (_this.legendPlacement === chart_configuration_1.Placement.RIGHT || _this.legendPlacement === chart_configuration_1.Placement.LEFT)
                                ? _this.legendContainerSize.width
                                : 0);
                    titleY = _this.height;
                }
                else if (d.placement === chart_configuration_1.Placement.LEFT) {
                    titleX = _this.titleContainerSize.width;
                    titleY = _this.height;
                }
                else if (d.placement === chart_configuration_1.Placement.BOTTOM) {
                    titleY =
                        _this.height +
                            (_this.margin.top + _this.margin.bottom) +
                            (_this.axisTitleMargin.top + _this.axisTitleMargin.bottom) +
                            (_this.isLegend && (_this.legendPlacement === chart_configuration_1.Placement.TOP || _this.legendPlacement === chart_configuration_1.Placement.BOTTOM)
                ...
                var rotate = d.placement === chart_configuration_1.Placement.LEFT || d.placement === chart_configuration_1.Placement.RIGHT ? -90 : 0;
            ...
            this.titleGroup
                ...
                var x = 0;
                var y = 0;
                if (d.placement === chart_configuration_1.Placement.TOP || d.placement === chart_configuration_1.Placement.BOTTOM) {
                    x =
                        (_this.width + _this.margin.left + _this.margin.right) / 2 -
                            (_this.isLegend && _this.legendPlacement === chart_configuration_1.Placement.LEFT ? _this.legendContainerSize.width : 0);
                    y = textHeight / 2 + 3;
                }
                else {
    ...
    ChartBase.prototype.updateAxis = function () {
        ...
        this.scales.forEach(function (scale) {
            ...
            maxTextWidth[scale.orient] = (0, axis_1.drawAxisByScale)({
                width: _this.width,
                height: _this.height
    ...
    ChartBase.prototype.setupScale = function (axes, width, height, reScaleAxes) {
        ...
        if (!reScaleAxes || (reScaleAxes && !reScaleAxes.length)) {
            ...
            this.currentScale = tslib_1.__spreadArray([], reScaleAxes, true);
        }
        return (0, axis_1.generateScaleByAxis)(axes, this.originalData, { width: width, height: height }, this.currentScale, this.isRealTime);
    };
    ...
    ChartBase.prototype.onLegendAllCheckBoxItemClick = function (d, index, nodeList) {
        ...
        this.legendGroup
            ...
            (0, d3_selection_1.select)(node[i]).style('opacity', item.checked ? 1 : 0);
        });
        if (this.isLegendAllHide) {
            // select 해제
            this.legendGroup.selectAll('.legend-label-group').each(function (item, i, node) {
                item.selected = true;
                (0, d3_selection_1.select)(node[i]).style('opacity', 1);
            });
        }
    };
