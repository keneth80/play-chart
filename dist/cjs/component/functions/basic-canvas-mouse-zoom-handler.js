...
exports.BasicCanvasMouseZoomHandler = void 0;
...
var BasicCanvasMouseZoomHandler = /** @class */ (function (_super) {
    tslib_1.__extends(BasicCanvasMouseZoomHandler, _super);
    ...
    BasicCanvasMouseZoomHandler.prototype.enable = function (chartData, scales, geometry) {
        ...
        this.pointerCanvas.call((0, d3_drag_1.drag)()
    ...
    BasicCanvasMouseZoomHandler.prototype.disable = function () {
        ...
        if (this.pointerCanvas) {
            ...
            this.pointerCanvas.call((0, d3_drag_1.drag)().on('start', null).on('drag', null).on('end', null));
        }
        this.isEnable = false;
    };
...
exports.BasicCanvasMouseZoomHandler = BasicCanvasMouseZoomHandler;
