...
exports.BasicZoomSelection = void 0;
...
var BasicZoomSelection = /** @class */ (function (_super) {
    tslib_1.__extends(BasicZoomSelection, _super);
    ...
    BasicZoomSelection.prototype.drawFunctions = function (chartData, scales, geometry) {
        ...
        this.mainGroup.call((0, d3_zoom_1.zoom)()
            .scaleExtent([0.5, 10])
            .extent([
            [0, 0],
...
exports.BasicZoomSelection = BasicZoomSelection;
