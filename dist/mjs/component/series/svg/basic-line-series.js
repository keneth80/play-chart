...
var BasicLineSeries = /** @class */ (function (_super) {
    __extends(BasicLineSeries, _super);
    ...
    BasicLineSeries.prototype.drawSeries = function (chartData, scales, geometry, option) {
        ...
        if (this.config.line) {
            ...
            if (this.isAnimation && option.displayType === DisplayType.NORMAL) {
                ...
                lineSeries_1.transition(transition().delay(200).duration(800).ease(easeLinear)).style('stroke-dashoffset', 0);
                delayExcute(1000, function () {
                    lineSeries_1
